...
/// `~/Library/Preferences/software.trypwood.jellybeat.plist`).
///
/// One slot per app, keyed by `(service, account)`. To clear it manually:
///
/// ```
/// security delete-generic-password \
///     -s software.trypwood.jellybeat \
///     -a software.trypwood.jellybeat.apikey
/// ```
nonisolated enum KeychainHelper {
    static let service = "software.trypwood.jellybeat"
    static let account = "software.trypwood.jellybeat.apikey"
